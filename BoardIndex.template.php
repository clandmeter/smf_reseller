		...
		<table class="table_list">
			...
			foreach ($category['boards'] as $board)
			{
				...
				if ($board['new'] || $board['children_new'])
					echo '
							<i class="fa fa-comments" style="font-size: 3em;"></i>';
				...
				// No new posts at all! The agony!!
					...
					echo '
							<i class="fa fa-comments-o" style="font-size: 3em;"></i>';
				...
				if (!empty($board['children']))
				{
					...
					echo '
					<p class="moderators" id="board_', $board['id'], '_children"><strong>', $txt['parent_boards'], '</strong>: ', implode(', ', $children), '</p>';
				}
